...
const AddressInfo = ({ address }) => {
    ...
    const storeAddress = useSelector((state) => state.auth.address);
    return (
        <div className='pt-4'>
            {noAddressExist ? (
                <div className='p-6 rounded-lg max-w-md mx-auto  flex-auto flex flex-col items-center justify-center'>
